...
class TrajectoryPublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("path_topic", "/tf_path")
        self.declare_parameter("src_frame_id", "odom")
        self.declare_parameter("dst_frame_id", "base_link")
        ...
        self.reference_frame_id = self.get_parameter("src_frame_id").value
        self.robot_frame_id = self.get_parameter("dst_frame_id").value
        ...
        self.last_pose = None
        self.path = Path()
        self.path.header.frame_id = self.get_parameter("src_frame_id").value
